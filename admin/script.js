...
function saveContacts() {
    let contacts = [
        { id: 1, name: "Zoe", lastname: "Zimmerman", email: "zoe.zimmerman@gmail.com", phone: "+49 143 679 865 34" },
        { id: 2, name: "Anna", lastname: "Anderson", email: "anna.anderson@example.com", phone: "+49 143 679 865 34" },
        { id: 3, name: "Zora", lastname: "Baker", email: "zora.baker@example.com", phone: "+49 143 679 865 34" },
        { id: 4, name: "Firat", lastname: "Carter", email: "firat.carter@web.de", phone: "+49 143 679 865 34" },
        { id: 5, name: "Carl", lastname: "Dawson", email: "carl.dawson@example.com", phone: "+49 143 679 865 34" },
        { id: 6, name: "Alwin", lastname: "Evans", email: "emma.evans@example.com", phone: "+49 143 679 865 34" },
        { id: 7, name: "Joerg", lastname: "Foster", email: "joerg.foster@example.com", phone: "+49 143 679 865 34" },
        ...
        { id: 10, name: "Alex", lastname: "Irving", email: "alex.irving@example.com", phone: "+49 143 679 865 34" },
        ...
        { id: 19, name: "Jennifer", lastname: "Quincy", email: "jennifer.quincy@example.com", phone: "+49 143 679 865 34" },
        { id: 20, name: "Rita", lastname: "Roberts", email: "rita.roberts@example.com", phone: "+49 143 679 865 34" },
        { id: 21, name: "Sam", lastname: "Bath", email: "sam.bath@example.com", phone: "+49 143 679 865 34" },
        { id: 22, name: "Ulrich", lastname: "Thompson", email: "ulrich.thompson@example.com", phone: "+49 143 679 865 34" },
        { id: 23, name: "Julian", lastname: "Ulrich", email: "julian.ulrich@example.com", phone: "+49 143 679 865 34" },
        { id: 24, name: "Uta", lastname: "Vaughn", email: "uta.vaughn@example.com", phone: "+49 143 679 865 34" },
        { id: 25, name: "Mathilda", lastname: "Wilson", email: "mathilda.wilson@example.com", phone: "+49 143 679 865 34" },
