...
async function fetchTasks() {
   ...
   if (tasks) {
      ...
      // addContainerData(tasks,'to-do'         ,'todo-container');
      addContainerData(tasks,'in-progress'   ,'in-progress-container');
      addContainerData(tasks,'await-feedback','await-feedback-container');
      addContainerData(tasks,'done'          ,'done-container');
...
function addContainerData(tasks,status,id) {
